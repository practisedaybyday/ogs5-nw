...
>>>>>>> style
	...
	short GetDCValue_MT(long node_Index,
	                    int timelevel,
	                    double* m_DC,
	                    double* m_DC_pts,
	...
	double* m_Vs_buff, * m_Ms_buff, * m_Gs_buff, * m_Hs_buff, * m_IC_buff, * m_pH_buff,
	* m_pe_buff, * m_Eh_buff;
	double* m_xDC_buff, * m_xPH_buff,* m_aPH_buff,* m_xPA_buff,* m_excess_water_buff,
	* m_excess_gas_buff,* m_dul_buff, * m_dll_buff, * m_Node_Volume_buff, * m_saturation_buff,
	* m_bIC_buff,* m_bIC_dummy_buff, * m_xDC_pts_buff, * m_xDC_MT_delta_buff,
	* m_xDC_Chem_delta_buff;
